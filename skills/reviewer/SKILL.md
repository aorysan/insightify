---
name: insightify-reviewer
description: Stage 4 - Evaluate generated docs across 5 quality dimensions and generate report.
---

# Insightify Reviewer Skill

This skill reviews generated documentation across 5 quality dimensions.
...
3. If verdict is `changes_needed`, send specific page issues back to Stage 3 Writer.
...
## Issue Format for Stage 3 (Writer)

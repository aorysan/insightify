...
5. Assemble `knowledge-base.md` from the 14 knowledge category files.
...
- **knowledge-base.md**: Concatenate 14 category files with `## Category` headings, strip YAML frontmatter, preserve all `> **Source:**` citations.
